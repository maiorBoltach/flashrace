...
{
	$query1 = 'SELECT * FROM users LEFT JOIN race ON users.user_id = race.user_id WHERE users.user_id='.$_SESSION['user']; 
    ...
    <div class="snap-drawers">
         <div class="snap-drawer snap-drawer-left">        
			...
			<p class="sidebar-divider">Гонка</p><div class="sidebar-menu">
							<a class="menu-item menu-item-active" href="/team.php">
