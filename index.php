            ...
            <!--Page content goes here, fixed elements go above the all elements class-->
                ...
                <div class="homepage-slider container-fullscreen">
                    ...
                    <div class="homepage-slider-transition" data-snap-ignore="true">
                        ...
                        <div class="homepage-slider-item">
                            ...
                            <p class="right-text">FLASHRACE - спортивно-интеллектуальная гонка</p>
                ...
                <div class="container">
                    ...
                    <p>
                        ...
                        Вы находитесь на странице спортивно-интеллектуальной квест-гонки FLASHRACE. Гонки, в которой студенты БГУ прикладывают свои знания, сообразительность и силу для победы над своими одногруппниками и однокурсниками!
