		...
		<div class="content">
            ...
            <!--Page content goes here, fixed elements go above the all elements class-->  
				...
				<div id="content-1">
					...
					<thead><tr><th class="table-title">ID КП</th><th class="table-title">Название</th><th class="table-title">Текст задания</th><th class="table-title">Код</th><th colspan="2"></th></tr></thead><tbody>
					<?php
