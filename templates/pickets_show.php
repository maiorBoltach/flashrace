...
<title><?php echo $PRETITLE; ?> | Контрольные пикеты</title>
		...
		<div class="content">
            ...
            <!--Page content goes here, fixed elements go above the all elements class-->  
				 ...
				 <div class="heading-style-1 container half-bottom">
                    ...
                    <h4>Список контрольных пикетов</h4>
				...
				echo '<table id="myTable" cellspacing=\'0\' class="table">';
				echo '<thead><tr><th class="table-title">ID КП</th><th class="table-title">Название</th><th class="table-title">Текст задания</th><th class="table-title">Код</th><th colspan="2"></th></tr></thead><tbody>';
					...
					{ 
						...
						echo '<td><a href="'.$_SERVER['PHP_SELF'].'?action=editform&id='.$item['id'].'"><i class="fa fa-pencil"></i></a></td>'; 

						echo '<td><a href="'.$_SERVER['PHP_SELF'].'?action=delete&id='.$item['id'].'"><i class="fa fa-trash"></i></a></td>';
