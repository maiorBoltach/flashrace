		...
		<div class="wrapper">		<!-- wrapper begins -->
			...
			<div id="holder">
				...
				<div class="pagetitle">
					...
					<li><?php echo '<a href="/admin/team_edit.php?team=change_pass&id='.$team['user_id'].'" class="active">Сменить пароль</a>'; ?>
					</ul>	
				...
				<div id="content">
					...
					echo '<p><label>Новый пароль команды</label><br />'; 
					echo '<input type="password" class="text" name="pass" /></p>'; 
