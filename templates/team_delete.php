...
<title><?php echo $PRETITLE; ?> | Удаление команды</title>
			...
			<p class="sidebar-divider">Админ-панель</p><div class="sidebar-menu">
				...
				<a class="menu-item show-submenu menu-item-active" href="#">
					...
					<?php
                        ...
                        <a class="submenu-item submenu-item-active" href="/admin/team_edit.php?team=delete&id='.$_GET['id'].'">    <i class="fa fa-angle-right"></i><em>  Удалить команду  </em><i class="fa fa-circle"></i></a>';
						?>
                    </div>
                </div>
		...
		<div class="content">
            ...
            <!--Page content goes here, fixed elements go above the all elements class-->  
				...
				<div class="heading-style-1 container half-bottom">
                    ...
                    <h4>Удаление команды</h4>
                    <div class="heading-block bg-red-dark"></div>
                    <div class="heading-decoration bg-red-dark"></div>
                </div>
				<center><h4>Удалить команду??</h4>
                            <p> Удаление необратимо. Восстановить команду, а также её данные (в т.ч. и статистику) будет невозможно!</p></center>
				 <div class="container">
			...
			<?php
					echo '<form name="delete_team" action="'.$_SERVER['PHP_SELF'].'?team=delete_team&id='.$_GET['id'].'" method="POST">'; 
