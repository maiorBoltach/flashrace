		...
		<div class="wrapper">		<!-- wrapper begins -->
			...
			<div id="holder">
				...
				<div class="pagetitle">
					...
					<li><?php echo '<a href="/admin/team_edit.php?team=fine&id='.$team['user_id'].'" class="active">Штрафы и бонусы</a>'; ?>
				...
				<div id="content">
					...
					<h3>Добавление / Изменение Штрафа (Бонуса) Команды</h3>
					<?php
					echo '<form name="fine" action="'.$_SERVER['PHP_SELF'].'?team=update_fine&id='.$_GET['id'].'" method="POST">'; 
					echo '<p><label>ID контрольного пикета</label><br />'; 
					echo '<input type="text" class="text" name="id" value="1" /></p>'; 
					echo '<p><label>Штраф (в секундах)</label><br />'; 
					echo '<input type="text" class="text" name="time" /></p>'; 
					echo '<p><label>Бонус (в секундах)</label><br />'; 
					echo '<input type="text" class="text" name="bonus" /></p>'; 
