    ...
    <div class="snap-drawers">
		...
		<div class="content">
			...
			<?php
					...
					echo '<input class="text-field green-field" name="num" onfocus="if (this.value==\'\') this.value = \'\'" onblur="if (this.value==\'\') this.value = \'\'" type="text"  value="'.$_GET['id'].'">';
                    echo '<label class="field-title contactMessageTextarea" for="contactMessageTextarea">Наименование: <span>(обязательно)</span></label>';
					echo '<input class="text-field green-field" name="name" onfocus="if (this.value==\'\') this.value = \'\'" onblur="if (this.value==\'\') this.value = \'\'" type="text"  value="'.$item['name'].'">';
					echo '<label class="field-title contactMessageTextarea" for="contactMessageTextarea">Описание: <span>(обязательно)</span></label>';
					echo '<textarea name="text" class="contactTextarea requiredField" id="contactMessageTextarea">'.$item['text'].'</textarea>';
					echo '<label class="field-title contactMessageTextarea" for="contactMessageTextarea">Код точки: <span>(обязательно)</span></label>';
					echo '<input class="text-field green-field" name="code" onfocus="if (this.value==\'\') this.value = \'\'" onblur="if (this.value==\'\') this.value = \'\'" type="text"  value="'.$item['code'].'">';
