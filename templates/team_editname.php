		...
		<div class="wrapper">		<!-- wrapper begins -->
			...
			<div id="holder">
				...
				<div class="pagetitle">
					...
					<li><?php echo '<a href="/admin/team_edit.php?team=change_name&id='.$team['user_id'].'" class="active">Переименовать</a>'; ?>
				...
				<div id="content">
					...
					<h3>Изменение логина и названия команды</h3>
					<?php
					echo '<form name="change_name" action="'.$_SERVER['PHP_SELF'].'?team=update_name&id='.$_GET['id'].'" method="POST">'; 
					echo '<p><label>Логин команды</label><br />'; 
					echo '<input type="text" class="text" name="email" value="'.$item['user_email'].'" /></p>'; 
					echo '<p><label>Название команды</label><br />'; 
					echo '<input type="text" class="text" name="name" value="'.$item['user_name'].'" /></p>'; 
