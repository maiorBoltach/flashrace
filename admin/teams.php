...
<title><?php echo $PRETITLE; ?> | Список команд</title>
    ...
    <div class="snap-drawers">
			...
			<a class="menu-item" href="/admin/main.php">
				...
				<a class="menu-item show-submenu  menu-item-active" href="#">
					...
					<div class="submenu  submenu-active">
                        <a class="submenu-item  submenu-item-active" href="/admin/teams.php">    <i class="fa fa-angle-right"></i><em>  Просмотр команд   </em><i class="fa fa-circle"></i></a>
		...
		<div class="content">
			...
			<div class="heading-style-1 container half-bottom">
                    <a href="#"><i class="fa fa-refresh fa-users"></i></a>
                    <h4>Список команд</h4>
			...
			<?php
			include_once '../php/admin_teams.php';
			?>
