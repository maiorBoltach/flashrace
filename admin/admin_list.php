...
if(!isset($_SESSION['admin_id']))
{
	...
	if($_GET["do"]=="delete")
	{
		...
		mysql_query ( $query ); 
		header( 'Location: /admin/admin_list.php?status=success' );
		die();
	}
...
<title><?php echo $PRETITLE; ?> | Список администрации</title>
    ...
    <div class="snap-drawers">
        <div class="snap-drawer snap-drawer-left">        
           ...
           <?php 
			...
			<p class="sidebar-divider">Админ-панель</p>
			...
			<a class="menu-item" href="/admin/main.php">
				...
				<a class="menu-item show-submenu menu-item-active" href="#">
					...
					<div class="submenu submenu-active">
                        <a class="submenu-item submenu-item-active" href="/admin/admin_list.php">    <i class="fa fa-angle-right"></i><em> Список админов  </em><i class="fa fa-circle"></i></a>
		...
		<div class="content">
			...
			<div class="heading-style-1 container half-bottom">
                    <a href="#"><i class="fa fa-refresh fa-user-secret"></i></a>
			...
			<?php
				...
				$res = mysql_query("SELECT * FROM admin"); 
					...
					<thead><tr><th class="table-title">ID</th><th class="table-title">Логин</th><th></th></tr></thead><tbody>';
					
					while ( $team = mysql_fetch_array( $res ) ) 
					{ 
						echo '<tr>'; 
						echo '<td>'.$team['admin_id'].'</td>'; 
						echo '<td class="table-sub-title">'.$team['admin_login'].'</td>'; 
						echo '<td><a href="/admin/admin_list.php?do=delete&id='.$team['admin_id'].'"><i class="fa fa-trash"></a></td>'; 
						echo '</tr>'; 
					}
					echo '</tbody></table>';
			?>
