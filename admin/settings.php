...

{
	...
	$query = mysql_query("UPDATE settings SET status_all = -1");

	$query2 = mysql_query("UPDATE race SET status = -1");
...

{
	...
	$query = mysql_query("UPDATE settings SET status_all = NULL");

	$query2 = mysql_query("UPDATE race SET status = NULL");
...

{
	...
	$query = mysql_query("UPDATE race SET status = NULL, kol_left_id =0, actual_id =0, help_used =0, actual_help =0, begin =NULL, end  =NULL,
            ...
            <!--Page content goes here, fixed elements go above the all elements class-->  
					...
					<div class="container" align="center">
						...
						<form action="" method="post"> <?php
							...
							$query2 = mysql_query("SELECT status_all FROM settings");

							$res = mysql_fetch_assoc($query2);

							if($res['status_all'] == NULL) echo "<input type=\"submit\" class=\"button button-green\"  value=\"ЗАПУСТИТЬ ГОНКУ\" name = \"start\"/>";

							else if($res['status_all'] != NULL) { echo "<input type=\"submit\" class=\"button button-red\"  value=\"ОСТАНОВИТЬ ГОНКУ\" name = \"start_again\"/>"; }
