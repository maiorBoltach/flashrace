...
include_once '../php/admin_login_script.php';
...
<div class="all-elements">
    <div class="snap-drawers">
        <div class="snap-drawer snap-drawer-left">        
			...
			<a class="menu-item  menu-item-active" href="/admin/">
        ...
        <div id="content" class="snap-content">
            ...
            <div class="pageapp-login bg-4 cover-screen">    
                <div class="pageapp-login-content cover-center">
                    <div class="unboxed-layout">
                        ...
                        <div class="pageapp-login-field">
                            ...
                            <input type="text" value="Логин" name = "login_admin" onfocus="if (this.value=='Логин') this.value = ''" onblur="if (this.value=='') this.value = 'Логин'" required>
                        </div>
                        <div class="pageapp-login-field">
                            <i class="fa fa-lock"></i>
                            <input type="password" value="Пароль" name = "login_pass" onfocus="if (this.value=='Пароль') this.value = ''" onblur="if (this.value=='') this.value = 'Пароль'" required>
                        </div>
						<?php if(isset($_GET['send'])) echo $message; ?>
                        <input type="submit" name="btn-login-admin" class="buttonWrap button button-green contactSubmitButton" value="Войти">   
