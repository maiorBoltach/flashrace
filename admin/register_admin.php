...
include_once '../scripts/admin_register_script.php';
?>
		...
		<div class="wrapper">		<!-- wrapper begins -->
			...
			<div id="holder">
				<div class="pagetitle">
					...
					<li><a href="/admin/register_admin.php" class="active">Добавить админа</a>
					</ul>
				</div>	
				...
				<div id="content">
					<div id="wide" align="center">
								...
								<?php echo $message; ?>
								<p><input type="text" class="text" name="admin_email" placeholder="Логин" required/></p>
								<p><input type="password" class="text" name = "admin_pass" placeholder="Пароль" required/></p>
								<p><input type="submit" class="submit" value="Добавить" name="btn-signup-admin"/></p>
