...
include_once '../php/admin_register_script.php';
 ?>
...
<title><?php echo $PRETITLE; ?> | Создать нового админа</title>
    ...
    <div class="snap-drawers">
			...
			<a class="menu-item" href="/admin/main.php">
				...
				<a class="menu-item show-submenu menu-item-active" href="#">
					...
					<div class="submenu submenu-active">
                        ...
                        <a class="submenu-item submenu-item-active" href="/admin/register_admin.php">        <i class="fa fa-angle-right"></i><em>  Добавить админа  </em><i class="fa fa-circle"></i></a>
                    </div>
                </div>
		...
		<div class="content">
            ...
            <!--Page content goes here, fixed elements go above the all elements class-->  
                    ...
                    <h3 class="heading-title">Администрация</h3>
                    <em class="heading-subtitle">Управление списками админов</em>
                    <div class="overlay bg-black"></div>
                </div>
             <div class="heading-style-1 container half-bottom">
                    <a href="#"><i class="fa fa-user-secret"></i></a>
                    <h4>Создание нового админа</h4>
				...
				<label class="field-title contactMessageTextarea" for="contactMessageTextarea">Логин админа: <span>(обязательно)</span></label>
				<input class="text-field green-field" name="admin_email" onfocus="if (this.value=='') this.value = ''" onblur="if (this.value=='') this.value = ''" type="text"  value="">
				
				<label class="field-title contactMessageTextarea" for="contactMessageTextarea">Пароль: <span>(обязательно)</span></label>
				
				<input name = "admin_pass" class="text-field green-field" onfocus="if (this.value=='password') this.value = ''" onblur="if (this.value=='') this.value = 'password'" type="password" value="password">
				
				<?php echo $message;?>
				
				<input type="submit" class="buttonWrap button button-orange contactSubmitButton" name="btn-signup-admin" value="Создать"/>
