			...
			<a class="menu-item" href="/admin/settings.php">
				...
				<a class="menu-item show-submenu submenu-active" href="#">
					...
					<div class="submenu submenu-active">
                        <a class="submenu-item submenu-item-active" href="/admin/table.php">    <i class="fa fa-angle-right"></i><em> Малая таблица   </em><i class="fa fa-circle"></i></a>
